...
1. It will output the result of any expression as single and double precision, converted from bits,
in addition to other representations.

2. It will accept single (1.23f) and double (1.23) precision numbers in the expression, these
will be converted to bits. There is no non-integer maths implemented.
